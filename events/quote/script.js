console.log('Welcome go Quote Generator!')
...
let numberOfQuote = quotes.length-1;

let startQuote = Math.floor(Math.random()* numberOfQuote);

author.innerHTML = quotes[startQuote].author;

quote.innerHTML= quotes[startQuote].quote;

profession.innerHTML=quotes[startQuote].profession;

topic.innerHTML= quotes[startQuote].topics[0];

console.log(quotes[3].topics[0]);


newQuote.addEventListener('click', ()=>{
    console.log('new quote?')
    let random = Math.floor(Math.random()*numberOfQuote);
    // console.log(random)
    ...
    topic.innerHTML= quotes[random].topics[0]
